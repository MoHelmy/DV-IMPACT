...
<div class="jumbotron" style="margin-bottom:0px;height:100%">
      ...
      <span id="title_fix"></span>   
          <p><h2 style="margin-bottom:30px;"><span style="color:#262626"><strong>DV<span style="color: #ea2f10;">-IMPACT</span></strong></span> PPI Search</h2></p>
		<br>
<p id="main-top-text">The impacts of missense mutations on <b id="prot-name" style="color:#ea2f10"></b>  protein interactions in <b id="tumor_c2" style="color:#ea2f10"></b> disease(s)/tissue(s).</p>
    ...
    <div class="col-md-2" style="padding:0;margin:0;">
        <div class="panel panel-default">
          ...
          <div class="panel-body stats-body">
            <p> <b id="prot_c"></b> proteins interact with the <b id="dm_c"></b> domain of <b id="prot-name2"></b> In <b id="tumor_c"></b> disease(s)/tissues(s).</p>
