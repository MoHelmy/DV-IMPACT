...
<div class="container">
      ...
      <p id="main-top-text">Variant(s) of <span style="color:#ea2f10" id="gene-name"><?php echo $_GET['variant']?> </span> protein.</p>
  ...
  <div class="navbar-collapse collapse navbar-responsive-collapse">
    ...
    <?php if(isset($_GET['tissues'])){
      ?>
      <p style="margin-top:20px;margin-bottom:60px;font-size:1.2em;text-align:center;"> <a id="showall" href="#" class="btn btn-default">Click here to view all variants for this protein.</a></p>
      <?php
    }
    ?>
    </div>
