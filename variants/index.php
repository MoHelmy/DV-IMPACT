...
<div class="jumbotron" style="margin-bottom:0px;height:100%">
      ...
      <span id="title_fix"></span>
          <p><h2 style="margin-bottom:30px;"><span style="color:#262626"><strong>DV<span style="color: #ea2f10;">-IMPACT</span></strong></span> Variants Search</h2></p>
		<br>
      <p id="main-top-text" align="justify">The <span style="color:#ea2f10"><span style="color:#262626"><strong>DV<span style="color: #ea2f10;">-IMPACT</span></strong></span></span> variants search feature provides the information and full sequences of the disease variants and the corresponding wildtype proteins. This feature helps in building custom variants database in FASAT format that can be used in identifying disease variants using MS/MS-based proteomics, for instance.</p>
...
<!--        -->
      ...
      <li class="dropdown">
      <a href="#" class="dropdown-toggle filter-dropdown" data-toggle="dropdown">Filter Disease/Tissue <b class="caret"></b></a>
  ...
  <table class="table table-striped table-hover" id="variant-table">
   ...
   ?>
     ...
     <input type="hidden" name="search" value="yes">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="selectmultiple">Select Specific Diseases/Tissues</label>
        <div class="col-md-7">
